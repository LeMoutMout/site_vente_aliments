            ...
            if (!empty($produits)) { ?>
                <div class="no_warp productor_block">
                    ...
                    <div class="producteur align_center warp">
                        ...
                        <div class="voir_avis" onclick="location.href = 'pageProducteur.php?prod=<?php echo $producteurs[$producteur]['id_production']?>'"><!-- mettre le parametre necesaire -->
                            plus d'informations
                        </div>
                    </div>
                    <!--sa fini la-->
                    <div class="bloc_scrollable_x flex_space_arround">
