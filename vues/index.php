...
<body>
  <script src="../connexion.js"></script>
    <header class="header">
        ...
        <a href="index.html"><h1 id="header_logo">Vege<b class="header_logo_shop">Shop</b></h1></a>
        ...
        <i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          </svg></i></p><p class="header_connect_text" onclick="openPopup();">Se connecter</p></a>        </div>
        </div><p class="header_bar"><svg xmlns="http://www.w3.org/2000/svg" width="1520" height="2" viewBox="0 0 1520 2" fill="none">
