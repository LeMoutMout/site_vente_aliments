    ...
    <div class="flex-container">
        ...
        <div>
          ...
          <div class="scroll">
            ...
            foreach ($receivedMessages as $message) : ?>
              <div class="received">
                <div class="color-mail">
                  <br>
                  <p><strong>De :</strong> <?= $message['pren_util'] . ' ' . $message['nom_util']; ?></p>
                  <p id="adresse_mail">  <strong><?= $message['mail_util']?></strong></p>
                  <p ><strong>Date :</strong> <?= $message['date_message']; ?></p>
                  <p class="contenu_message" id="contenu_message"><strong>Contenu :</strong> <?= $message['contenu_message']; ?></p> <br>
                  <div class="form-icon">
                    <form method="post">
                      <input id="message_id_reply"type="hidden" name="message_id_reply" value="<?= $message['id_message']; ?>">
                      <input id="message_id_reply"type="hidden" name="message_id_reply" value="<?= $message['id_message']; ?>">
                      <button type="submit" class="reply-button" id="reply-button">
                        <img src="../images/reply.png" alt="répondre" class="reply-img">
                      </button>
                    </form>
                    <form method="post">
      ...
      <div class="flex-items1">
        <form id="new-conversation-form" method="post">
          <label for="participant-input">Envoyer un nouveau message : </label><br>
